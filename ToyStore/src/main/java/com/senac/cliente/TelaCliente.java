...
public class TelaCliente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        popUpMnu.add(mnuItemEdit);
        popUpMnu.add(jSeparator1);
        ...
        PainelClientes.setPreferredSize(new java.awt.Dimension(784, 713));
        ...
        tblCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CPF", "NOME", "SEXO", "DATA NASC", "E-MAIL", "TELEFONE"
            }
        ) {
        ...
        cboFiltroConsulta.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(190, 204, 200)));

        lblFiltrarPor.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
                ...
                .addGroup(PainelClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PainelClientesLayout.createSequentialGroup()
                        ...
                        .addGroup(PainelClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cboFiltroConsulta, 0, 400, Short.MAX_VALUE)
        ...
        PainelClientesLayout.setVerticalGroup(
            ...
            .addGroup(PainelClientesLayout.createSequentialGroup()
                ...
                .addGroup(PainelClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(lblFiltrarPor)
                    .addComponent(cboFiltroConsulta, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(12, 12, 12)
                .addGroup(PainelClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(lblBuscar1)
                    .addComponent(txtBuscarPor, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
        ...
        LayerCliente.setPreferredSize(new java.awt.Dimension(548, 756));
        ...
        txtDataNasc.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(140, 140, 140)));
        try {
            txtDataNasc.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        txtDataNasc.setDisabledTextColor(new java.awt.Color(190, 204, 200));
        ...
        txtCpf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(140, 140, 140)));
        try {
            txtCpf.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###.###.###-##")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        txtCpf.setDisabledTextColor(new java.awt.Color(190, 204, 200));
        ...
        txtEmail.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(190, 204, 200)));
        ...
        txtCivil.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(190, 204, 200)));
        txtCivil.setName("Estado Cívil"); // NOI18N
        ...
        txtRua.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(190, 204, 200)));
        txtRua.setName("Endereço"); // NOI18N
        ...
        txtNumero.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(190, 204, 200)));
        ...
        txtComplemento.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(190, 204, 200)));
        ...
        txtTelefone.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(140, 140, 140)));
        try {
            txtTelefone.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("(##)#####-####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        txtTelefone.setDisabledTextColor(new java.awt.Color(190, 204, 200));
        ...
        LayerClienteLayout.setHorizontalGroup(
            ...
            .addComponent(Cadastro, javax.swing.GroupLayout.DEFAULT_SIZE, 544, Short.MAX_VALUE)
        ...
        LayerClienteLayout.setVerticalGroup(
            LayerClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Cadastro, javax.swing.GroupLayout.DEFAULT_SIZE, 752, Short.MAX_VALUE)
            .addGroup(LayerClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(Default, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public void lerFormularioCliente() {
        ...
        for (int i = 0; i < listaClientes.size(); i++) {
            ...
            if (tblCliente.getValueAt(this.auxiliarEditCliente, 0) == listaClientes.get(i).getCpf()) {
    ...
    public void deletarCliente() {
        ...
        for (int i = 0; i < listaClientes.size(); i++) {
            if (tabelaCliente.getValueAt(this.auxiliarEditCliente, 1) == listaClientes.get(i).getNome()) {
                lerFormularioCliente();
    ...
    public boolean validarCampos() {
        try {
            ...
            JOptionPane.showMessageDialog(this, e.getMessage(), "Erro ao salvar cadastro", JOptionPane.WARNING_MESSAGE);
            return false;
        }
    }
    ...
    private void tblClienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClienteMousePressed
        ...
        if (evt.getButton() == MouseEvent.BUTTON3) {
            popUpMnu.show(evt.getComponent(), evt.getX(), evt.getY());
            int linhaClicada = tblCliente.rowAtPoint(point);
            tblCliente.setRowSelectionInterval(linhaClicada, linhaClicada);
        }
